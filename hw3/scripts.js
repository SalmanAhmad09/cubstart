...
const getCaption = (predictions) => {
    ...
    predictions.forEach(async (prediction) => {
        ...
        try {
            ...
            const accessToken = "57427322916148024c7922a8b6d346e18964675f";
            ...
            lineText += " #" + entity;
            let reverseLineText = lineText;
            const line = document.createElement("p");
            line.innerText = lineText;
            caption.appendChild(line);
            const reverseLine = document.createElement("p");
            reverseLine.innerText = "Now in reverse: " + reverseString(reverseLineText);
            caption.appendChild(reverseLine)
        } catch (error) {
            console.log(error);
        }
    })
...
//Function taken from freecodecamp.org
